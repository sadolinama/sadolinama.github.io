...
## 🧮 Modeling Approach
- Logistic regression used to predict readmission risk
- Features include age, length of stay, diagnosis risk, admission type
- Patients classified into Low / Medium / High risk tiers

## 📈 Dashboard
The Tableau dashboard provides:
- Executive KPI overview
- Diagnosis-level readmission trends
- Patient-level risk segmentation

## 💡 Key Insights
- Chronic conditions (Heart Failure, COPD, Kidney Disease) significantly increase readmission risk
